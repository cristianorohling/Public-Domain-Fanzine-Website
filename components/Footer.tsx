...
const SocialIcon: React.FC<{ href: string; children: React.ReactNode }> = ({ href, children }) => (
  <a href={href} target="_blank" rel="noopener noreferrer" className="text-medium-text hover:text-brand-primary transition-colors duration-300">
    {children}
  </a>
);
...
const Footer: React.FC = () => {
  return (
    <footer className="bg-dark-bg/80 backdrop-blur-lg border-t border-gray-800">
      <div className="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
          <p className="text-medium-text text-sm">&copy; {new Date().getFullYear()} Public Domain Fanzine. Todos os direitos reservados.</p>
          <div className="flex space-x-6">
            <SocialIcon href="https://www.facebook.com/public.domain.fanzines">
