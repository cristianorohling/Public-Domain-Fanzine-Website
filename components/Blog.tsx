...
const BlogPostCard: React.FC<{ post: BlogPost }> = ({ post }) => (
  <div className="bg-[#1a1a1a] p-6 rounded-lg border border-gray-800 hover:border-brand-primary transition-colors duration-300">
    ...
    <h3 className="text-2xl font-bold mb-3 text-light-text hover:text-brand-primary transition-colors">
    ...
    <section className="py-24 bg-transparent">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-medium-text max-w-2xl mx-auto">Bastidores, inspirações e novidades do nosso universo.</p>
        </div>
