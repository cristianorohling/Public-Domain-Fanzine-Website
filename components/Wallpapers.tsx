...
const WallpaperCard: React.FC<{ wallpaper: Wallpaper }> = ({ wallpaper }) => (
  ...
  >
    ...
    <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center p-4">
      <h3 className="text-xl font-bold text-white text-center">{wallpaper.title}</h3>
    </div>
  </a>
);
    ...
    <section className="py-24 bg-transparent">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter">Papéis de Parede</h2>
          <p className="mt-4 text-lg text-medium-text max-w-2xl mx-auto">Leve a arte do nosso zine para a sua área de trabalho.</p>
        </div>
